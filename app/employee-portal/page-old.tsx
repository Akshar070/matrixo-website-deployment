...
import { AlertTriangle, Briefcase, CalendarCheck, CalendarDays, CheckCircle, ChevronDown, Eye, EyeOff, History, IdCard, LineChart, List, ListTodo, Loader2, Lock, LogOut, Menu, MessageCircle, Moon, Plane, Plus, QrCode, ShieldCheck, Sun, Trash2, Umbrella, User, UserCircle, Video, X, XCircle } from 'lucide-react'
...
function LoginForm() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center p-3 sm:p-4 relative overflow-hidden" style={{ background: '#050816' }}>
      {/* Subtle ambient glow */}
      <div className={`absolute top-[-20%] left-[-10%] ${isMobile ? 'w-[360px] h-[360px] opacity-[0.12]' : 'w-[600px] h-[600px] opacity-[0.15]'} rounded-full blur-3xl`} style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.4) 0%, transparent 70%)' }} />
      <div className={`absolute bottom-[-10%] right-[-5%] ${isMobile ? 'w-[320px] h-[320px] opacity-[0.08]' : 'w-[500px] h-[500px] opacity-[0.1]'} rounded-full blur-3xl`} style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.3) 0%, transparent 70%)' }} />
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-[#F8FAFC] mb-2">Employee Portal</h1>
          <p className="text-sm sm:text-base text-[#94A3B8]">Access your attendance dashboard</p>
        </div>

        <div className="rounded-3xl p-5 sm:p-8 shadow-2xl" style={{ background: 'rgba(15,23,42,0.60)', backdropFilter: 'blur(20px) saturate(1.5)', WebkitBackdropFilter: 'blur(20px) saturate(1.5)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 24px 48px rgba(0,0,0,0.4)' }}>
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#94A3B8] flex items-center gap-2">
                <IdCard className="text-primary-400" />
                Employee ID
              </label>
              <input
                type="text"
                ...
                className="w-full py-3 px-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-transparent transition-all text-base text-[#F8FAFC] placeholder-slate-500"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full py-3 px-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/40 focus:border-transparent transition-all text-base text-[#F8FAFC] placeholder-slate-500 pr-12"
                  style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
                />
                <button
                  type="button"
          ...
          <div className="mt-6 text-center">
            <Link href="/" className="text-sm text-[#94A3B8] hover:text-primary-400 transition-colors">
        ...
        <div className="mt-6 flex items-center justify-center gap-4 text-xs text-slate-500">
          <span className="flex items-center gap-1">
            <Lock className="text-green-500" /> Secure Login
          </span>
          <span>.</span>
...
const navigationItems = [
  { id: 'attendance', label: 'Attendance', icon: CalendarCheck, adminHidden: true },
  ...
  { id: 'event-checkin', label: 'Event QR', icon: QrCode },
  { id: 'profile', label: 'My Profile', icon: UserCircle },
  { id: 'job-postings', label: 'Careers', icon: Briefcase, adminOnly: true },
]
            ...
            <div className="flex items-center gap-0.5">
              {navigationItems.filter(item => !item.adminOnly && !(item.adminHidden && employee?.role === 'admin')).map((item) => (
                <button
                  ...
                  className={`
                    relative flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg transition-all duration-200 font-medium text-xs whitespace-nowrap
                    ${activeTab === item.id 
              ...
              {isAdmin && (
                <>
                  <button
                    ...
                    `}
                  >
                    <Briefcase className="text-xs shrink-0" />
                    <span>Careers</span>
                    {pendingAppCount > 0 && (
                  ...
                  <button
                    ...
                    className={`
                      flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg transition-all duration-200 font-medium text-xs whitespace-nowrap
                      ${activeTab === 'admin'
                    ...
                    `}
                  >
                    <ShieldCheck className="text-xs shrink-0" />
                    <span>Admin</span>
                  </button>
                </>
              )}
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            >
              <AnimatePresence mode="wait">
                {darkMode ? (
                  ...
                  >
                    <Sun className="text-amber-400" size={14} />
                  </motion.div>
                ) : (
                  <motion.div
                    key="moon"
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className={`text-xs hidden md:block transition-transform ${darkMode ? 'text-neutral-400' : 'text-gray-500'} ${userMenuOpen ? 'rotate-180' : ''}`} />
              </button>
              ...
              {mounted && userMenuOpen && createPortal(
                ...
                >
                  ...
                  >
                    <div className="p-4 border-b rounded-t-2xl" style={{ borderColor: darkMode ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)' }}>
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className={`text-xs font-mono ${darkMode ? 'text-slate-500' : 'text-gray-400'}`}>{employee?.employeeId}</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-2">
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${darkMode ? 'text-slate-300 hover:bg-white/[0.05]' : 'text-gray-700 hover:bg-black/[0.04]'}`}
                      >
                        <UserCircle />
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/[0.08] rounded-xl transition-colors"
                      >
                        <LogOut />
                        <span>Sign Out</span>
                      </button>
            ...
            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                  className={`lg:hidden p-2 rounded-lg transition-all ${darkMode ? 'text-[#94A3B8] hover:text-white bg-white/[0.04] hover:bg-white/[0.08]' : 'text-gray-500 hover:text-gray-900 bg-black/[0.03] hover:bg-black/[0.06]'}`}
            >
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              style={{ borderTop: darkMode ? '1px solid rgba(255,255,255,0.06)' : '1px solid rgba(0,0,0,0.06)' }}
            >
                ...
                {navigationItems.filter(item => (!item.adminOnly || isAdmin) && !(item.adminHidden && employee?.role === 'admin')).map((item) => (
                  <button
                    ...
                    className={`
                      ...
                      ${activeTab === item.id 
                        ? 'bg-primary-500/15 text-primary-400 border border-primary-500/15' 
                        : darkMode
                          ? 'text-[#94A3B8] hover:text-white hover:bg-white/[0.04] border border-transparent'
                          : 'text-gray-500 hover:text-gray-900 hover:bg-black/[0.03] border border-transparent'
                      }
                    `}
                  >
                    <item.icon />
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${activeTab === 'admin' 
                        ...
                        : darkMode
                          ? 'text-amber-400/60 hover:text-amber-400 hover:bg-amber-500/[0.06] border border-transparent'
                          : 'text-amber-600/70 hover:text-amber-600 hover:bg-amber-500/[0.06] border border-transparent'
                      }
                    `}
                  >
                    <ShieldCheck />
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <Loader2 className="animate-spin text-4xl text-primary-500" />
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        style={{
          background: darkMode ? 'rgba(15,23,42,0.60)' : 'rgba(255,255,255,0.65)',
          backdropFilter: 'blur(20px) saturate(1.5)',
          WebkitBackdropFilter: 'blur(20px) saturate(1.5)',
          border: darkMode ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(255,255,255,0.8)',
          boxShadow: darkMode ? '0 8px 24px rgba(0,0,0,0.25)' : '0 8px 20px rgba(59,130,246,0.06)',
        }}
      >
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          />
            ...
            <h2 className={`text-lg sm:text-2xl font-bold truncate ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              ...
              <p className={`text-sm sm:text-base truncate ${darkMode ? 'text-[#94A3B8]' : 'text-gray-500'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          {myTasks.length === 0 ? (
            <p className={`text-center py-4 text-sm sm:text-base ${darkMode ? 'text-slate-500' : 'text-gray-400'}`}>No pending tasks</p>
          ) : (
        ...
        >
          ...
          <div className="flex gap-2 mb-3 sm:mb-4">
            ...
            >
              {addingTodo ? <Loader2 className="animate-spin" /> : <Plus />}
            </button>
          </div>

          {sortedTodos.length === 0 ? (
            <p className={`text-center py-4 ${darkMode ? 'text-slate-500' : 'text-gray-400'}`}>No todos yet. Add one above!</p>
          ) : (
                    ...
                    <button
                      ...
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${
                        todo.status === 'completed' 
                          ...
                          : darkMode ? 'border-slate-500 hover:border-primary-500' : 'border-gray-400 hover:border-primary-500'
                      }`}
                    >
                      {todo.status === 'completed' && <CheckCircle className="text-xs" />}
                    </button>
      ...
      {attendancePercentage < 80 && (
        <div className="rounded-xl p-4 flex items-start gap-3" style={{ background: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.15)' }}>
          <AlertTriangle className="text-red-400 mt-1 flex-shrink-0" />
          <div>
            <p className="text-red-400 font-medium">Low Attendance Warning</p>
            <p className={`text-sm mt-1 ${darkMode ? 'text-[#94A3B8]' : 'text-gray-500'}`}>
...
function HistoryTab() {
  ...
  const statusConfig: Record<string, { label: string; color: string; icon: any }> = {
    P: { label: 'Present', color: 'bg-green-500', icon: CheckCircle },
    A: { label: 'Absent', color: 'bg-red-500', icon: XCircle },
    L: { label: 'Leave', color: 'bg-yellow-500', icon: Umbrella },
    O: { label: 'On Duty', color: 'bg-blue-500', icon: Briefcase },
    H: { label: 'Holiday', color: 'bg-blue-500', icon: Plane }
  }
    ...
    <div className="space-y-4 sm:space-y-6">
      <div
        ...
        style={{
          ...
          WebkitBackdropFilter: 'blur(20px) saturate(1.5)',
          border: darkMode ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(255,255,255,0.8)',
          boxShadow: darkMode ? '0 8px 24px rgba(0,0,0,0.25)' : '0 8px 20px rgba(59,130,246,0.05)',
        }}
      >
        ...
        {loading ? (
          <div className="flex justify-center py-8">
            <Loader2 className="animate-spin text-3xl text-primary-500" />
          </div>
        ) : records.length === 0 ? (
            <p className={`text-center py-8 ${darkMode ? 'text-slate-500' : 'text-gray-400'}`}>No attendance records for this month</p>
        ) : (
          <div className="space-y-2 sm:space-y-3">
            {records.map((record) => {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <div
        ...
        style={{
          background: darkMode ? 'rgba(15,23,42,0.60)' : 'rgba(255,255,255,0.75)',
          backdropFilter: 'blur(20px) saturate(1.5)',
          WebkitBackdropFilter: 'blur(20px) saturate(1.5)',
          border: darkMode ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(255,255,255,0.8)',
          boxShadow: darkMode ? '0 8px 24px rgba(0,0,0,0.25)' : '0 8px 20px rgba(59,130,246,0.06)',
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
          ...
          <div className="relative flex-shrink-0">
            <div className="w-28 h-28 rounded-full overflow-hidden ring-4 ring-blue-500/30 bg-blue-600">
              {displayImage ? (
                <img
                  src={displayImage}
                  alt={employee.name}
          ...
          <div className="text-center sm:text-left flex-1">
            ...
            <p className="text-primary-500 font-medium text-base mb-1">
              {employee.designation || employee.role}
            </p>
            {employee.department && (
              <p className={`text-sm mb-4 ${darkMode ? 'text-[#94A3B8]' : 'text-gray-500'}`}>
                {employee.department}
              </p>
            )}
            <ProfilePhotoUpload
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {infoRows.map(({ label, value }) =>
            value ? (
              ...
              >
                <p className={`text-xs font-medium mb-0.5 ${darkMode ? 'text-slate-500' : 'text-gray-400'}`}>
                  {label}
                </p>
                <p className={`text-sm font-medium break-all ${darkMode ? 'text-slate-200' : 'text-gray-800'}`}>
                  {value}
                </p>
              </div>
            ) : null
      ...
      <div
        ...
        style={{
          ...
          border: darkMode ? '1px solid rgba(59,130,246,0.15)' : '1px solid rgba(59,130,246,0.12)',
        }}
      >
        <p className={`font-medium mb-1 ${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
          Profile Photo Guidelines
        </p>
        <ul className={`space-y-0.5 list-disc list-inside text-xs ${darkMode ? 'text-[#94A3B8]' : 'text-gray-500'}`}>
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        WebkitBackdropFilter: 'blur(20px) saturate(1.5)',
        border: darkMode ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(255,255,255,0.8)',
        boxShadow: darkMode ? '0 8px 20px rgba(0,0,0,0.2)' : '0 6px 16px rgba(59,130,246,0.05)',
        transition: 'box-shadow 0.2s, transform 0.2s',
      }}
    >
      <div className="flex items-start justify-between">
        <div className="min-w-0 flex-1">
          <p className={`text-xs sm:text-sm truncate ${darkMode ? 'text-[#94A3B8]' : 'text-gray-500'}`}>{title}</p>
...
function Dashboard() {
  ...
  return (
    ...
    <div
      ...
      style={{
        background: darkMode
          ? 'radial-gradient(ellipse at 20% 10%, rgba(59,130,246,0.08) 0%, transparent 55%), #050816'
          : 'radial-gradient(ellipse at 20% 10%, rgba(59,130,246,0.06) 0%, transparent 55%), #f8fafc',
      }}
    >
      {/* Top Navigation */}
      ...
      <footer
        ...
        style={{ borderTop: darkMode ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.06)' }}
      >
        <p className={`text-center text-sm ${darkMode ? 'text-slate-500' : 'text-gray-400'}`}>
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: '#050816' }}>
        <div className="text-center p-10 rounded-3xl" style={{ background: 'rgba(15,23,42,0.60)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.08)' }}>
          <Loader2 className="animate-spin text-5xl text-primary-500 mx-auto mb-4" />
